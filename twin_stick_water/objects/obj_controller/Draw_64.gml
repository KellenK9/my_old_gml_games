...
//draw accelerometer
//draw_sprite(spr_accelerometer, 0, minimap_offset, minimap_offset + healthbar_offset + 270)
...
if(instance_exists(obj_canoe)){
	player_x = obj_canoe.x / room_width * minimap_width
	player_y = obj_canoe.y / room_height * minimap_height
	draw_circle_color(minimap_offset + player_x, minimap_offset +player_y, 4, c_orange, c_orange, false)
	if(alarm[0] < 0){
		alarm[0] = 16/player_circle_speed
	}
	else{
